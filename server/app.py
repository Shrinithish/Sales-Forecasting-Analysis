...
mongoDB=pymongo.MongoClient('mongodb+srv://SalesPrediction:CdjbjvH6VPwz6t86@cluster0.fi8pwvt.mongodb.net/?retryWrites=true&w=majority')
db=mongoDB['SalesPrediction']
account=db.account

app=Flask(__name__)
app.secret_key='\xd8\xe9\xc0T\xc44\xd9\xf5\xaf%\xe1,\x1b\\=a\x1a^o\xdf\xe4|.l'
CORS(app)
